            ...
            switch($no){
                ...
                case 1:
                    ...
                    switch($j){
                        ...
                        case 'D':
                            $todo[] = " Mulai biasain nulis tipis-tipis, contohnya mulai dulu 1 paragraph per hari biar otak kamu mulai terbiasa.";
                            break;
                        ...
                        case 'F':
                            $todo[] = " Pelajari terlebih dahulu struktur bahasa yang ingin kamu pelajari, dan coba untuk menghafalkan minimal  kosakata setiap harinya.";
                            break;
                    }
                ...
                case 5:
                    ...
                    switch($j){
                        ...
                        case 'C':
                            $todo[] = " Kamu bisa challenge diri kamu buat nyari minimal satu fakta perharinya.";
                            break;
